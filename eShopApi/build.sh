...
${nuget_cmd} install src/epsilonSmart.eShopApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/epsilonSmart.eShopApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/epsilonSmart.eShopApi.dll \
-recurse:'src/epsilonSmart.eShopApi/*.cs' \
-doc:bin/epsilonSmart.eShopApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/epsilonSmart.eShopApi.dll was created successfully"
fi
